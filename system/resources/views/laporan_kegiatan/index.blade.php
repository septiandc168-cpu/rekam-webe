            ...
            <form action="{{ route('laporan_kegiatan.index') }}" method="GET" class="mb-0 no-loader" id="filter-form">
                <div class="export-form-container">
                    ...
                    <div class="d-none d-lg-flex input-group input-group-sm align-items-center">
                        ...
                        @if(request()->hasAny(['bulan','tahun','status','user_id']))
                            <a href="{{ route('laporan_kegiatan.index') }}" class="btn bg-navy text-white btn-sm flex-shrink-0 shadow-sm" title="Reset Filter">
                    ...
                    <div class="d-lg-none">
                        <div class="row g-2">
                            ...
                            <div class="col-12 mt-2 d-flex" style="gap:8px;">
                                ...
                                @if(request()->hasAny(['bulan','tahun','status','user_id']))
                                    <a href="{{ route('laporan_kegiatan.index') }}" class="btn bg-navy text-white btn-sm flex-grow-1 shadow-sm text-center">
                                        <i class="fas fa-undo mr-1"></i> Reset
                                    </a>
                                @endif
                            </div>
