...
@section('content')
    <div class="container">
        ...
        <form id="laporan-kegiatan-form" action="{{ route('laporan_kegiatan.update', $laporanKegiatan) }}" method="POST"
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $laporanKegiatan->rencanaKegiatan->getJenisKegiatanLabel() }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="2" readonly>{!! strip_tags($laporanKegiatan->rencanaKegiatan->deskripsi) !!}</textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tujuan</label>
                        <textarea class="form-control" rows="2" readonly>{!! strip_tags($laporanKegiatan->rencanaKegiatan->tujuan) !!}</textarea>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" 
                                    value="{{ $laporanKegiatan->rencanaKegiatan->waktu_mulai && $laporanKegiatan->rencanaKegiatan->waktu_selesai
            ...
            : ($laporanKegiatan->rencanaKegiatan->waktu_mulai
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" 
                                    value="{{ \Carbon\Carbon::parse($laporanKegiatan->rencanaKegiatan->tanggal_mulai)->format('d F Y') }} - {{ \Carbon\Carbon::parse($laporanKegiatan->rencanaKegiatan->tanggal_selesai)->format('d F Y') }}" readonly>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="realisasi_tanggal_mulai" class="form-control" 
                                        ...
                                        value="{{ old('realisasi_tanggal_mulai', $laporanKegiatan->realisasi_tanggal_mulai) }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="realisasi_tanggal_selesai" class="form-control" 
                                        ...
                                        value="{{ old('realisasi_tanggal_selesai', $laporanKegiatan->realisasi_tanggal_selesai) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $laporanKegiatan->rencanaKegiatan->estimasi_peserta ?? '-' }}" readonly>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" name="realisasi_peserta" class="form-control" 
                                    ...
                                    value="{{ old('realisasi_peserta', $laporanKegiatan->realisasi_peserta) }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="rangkaian_kegiatan" class="form-control" id="summernote-rangkaian" rows="3" 
                                    placeholder="Jelaskan rangkaian kegiatan atau alur acara dari awal hingga akhir..."
                                    required>{{ old('rangkaian_kegiatan', $laporanKegiatan->rangkaian_kegiatan) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="profil_peserta" class="form-control" id="summernote-profil" rows="3" 
                                    ...
                                    required>{{ old('profil_peserta', $laporanKegiatan->profil_peserta) }}</textarea>
                                <small class="form-text text-muted">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Hasil yang Dicapai <span class="text-danger">*</span></label>
                                <textarea name="hasil_dicapai" class="form-control" id="summernote-hasil" rows="4" 
                                    ...
                                    required>{!! old('hasil_dicapai', $laporanKegiatan->hasil_dicapai) !!}</textarea>
                                <small class="form-text text-muted">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Output Nyata <span class="text-danger">*</span></label>
                                <textarea name="output_nyata" class="form-control" id="summernote-output" rows="4" 
                                    ...
                                    required>{!! old('output_nyata', $laporanKegiatan->output_nyata) !!}</textarea>
                                <small class="form-text text-muted">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Dampak Awal yang Terlihat <span class="text-danger">*</span></label>
                                <textarea name="dampak_awal" class="form-control" id="summernote-dampak" rows="4" 
                                    ...
                                    required>{!! old('dampak_awal', $laporanKegiatan->dampak_awal) !!}</textarea>
                                <small class="form-text text-muted">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea name="kendala" class="form-control" id="summernote-kendala" rows="4" 
                                    placeholder="Jelaskan kendala yang dihadapi selama pelaksanaan kegiatan...">{!! old('kendala', $laporanKegiatan->kendala) !!}</textarea>
                                <small class="form-text text-muted">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Solusi yang Dilakukan</label>
                                <textarea name="solusi" class="form-control" id="summernote-solusi" rows="4" 
                                    placeholder="Jelaskan solusi yang dilakukan untuk mengatasi kendala...">{!! old('solusi', $laporanKegiatan->solusi) !!}</textarea>
                                <small class="form-text text-muted">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Catatan Evaluasi & Rekomendasi</label>
                                <textarea name="evaluasi_rekomendasi" class="form-control" id="summernote-evaluasi" rows="4" 
                                    placeholder="Berikan evaluasi dan rekomendasi untuk kegiatan selanjutnya...">{!! old('evaluasi_rekomendasi', $laporanKegiatan->evaluasi_rekomendasi) !!}</textarea>
                                <small class="form-text text-muted">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <!-- Foto Kegiatan Existing -->
                    @if (!empty($laporanKegiatan->foto_kegiatan))
                        <div class="mb-3">
                            <label class="form-label fw-bold">Foto Kegiatan Saat Ini</label>
                            <div class="row">
                                            ...
                                            <div class="card-body p-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="remove_foto_kegiatan[]" value="{{ $filePath }}"
                                                        id="remove_foto_kegiatan_{{ $index }}">
                                                    <label class="form-check-label" for="remove_foto_kegiatan_{{ $index }}">
                                                        <small>Hapus</small>
                                                    </label>
                                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label fw-bold">Upload Foto Kegiatan Baru</label>
                    ...
                    <div class="col-md-12">
                        <!-- Daftar Hadir Existing -->
                        @if (!empty($laporanKegiatan->daftar_hadir))
                            <div class="mb-3">
                                <label class="form-label fw-bold">Daftar Hadir Saat Ini</label>
                                <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-body p-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="remove_daftar_hadir[]" value="{{ $filePath }}"
                                                                id="remove_daftar_hadir_{{ $index }}">
                                                            <label class="form-check-label" for="remove_daftar_hadir_{{ $index }}">
                                                                <small>Hapus</small>
                                                            </label>
                                                        </div>
                                                    </div>
                        ...
                        @endif
                        <div class="mb-3">
                            <label class="form-label fw-bold">Upload Daftar Hadir Baru</label>
                    ...
                    <div class="col-md-12">
                        ...
                        @if (!empty($laporanKegiatan->notulen))
                            <div class="mb-3">
                                <label class="form-label fw-bold">Notulen Saat Ini</label>
                                <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-body p-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="remove_notulen[]" value="{{ $filePath }}"
                                                                id="remove_notulen_{{ $index }}">
                                                            <label class="form-check-label" for="remove_notulen_{{ $index }}">
                                                                <small>Hapus</small>
                                                            </label>
                                                        </div>
                                                    </div>
                        ...
                        @endif
                        <div class="mb-3">
                            <label class="form-label fw-bold">Upload Notulen Baru</label>
                    ...
                    <div class="col-md-12">
                        ...
                        @if (!empty($laporanKegiatan->materi))
                            <div class="mb-3">
                                <label class="form-label fw-bold">Materi Saat Ini</label>
                                <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="card-body p-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="remove_materi[]" value="{{ $filePath }}"
                                                                id="remove_materi_{{ $index }}">
                                                            <label class="form-check-label" for="remove_materi_{{ $index }}">
                                                                <small>Hapus</small>
                                                            </label>
                                                        </div>
                                                    </div>
                        ...
                        @endif
                        <div class="mb-3">
                            <label class="form-label fw-bold">Upload Materi Baru</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @if (!empty($laporanKegiatan->berita_acara))
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Berita Acara Saat Ini</label>
                                    <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-body p-2">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="remove_berita_acara[]" value="{{ $filePath }}"
                                                                    id="remove_berita_acara_{{ $index }}">
                                                                <label class="form-check-label" for="remove_berita_acara_{{ $index }}">
                                                                    <small>Hapus</small>
                                                                </label>
                                                            </div>
                                                        </div>
                            ...
                            @endif
                            <div class="mb-3">
                                <label class="form-label fw-bold">Upload Berita Acara Baru</label>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fotoInput = document.querySelector('input[name="foto_kegiatan[]"]');
            if (fotoInput) {
            ...
            const daftarHadirInput = document.querySelector('input[name="daftar_hadir[]"]');
            if (daftarHadirInput) {
                daftarHadirInput.addEventListener('change', function() {
                    createFilePreview(this, document.getElementById('preview-daftar-hadir'));
                });
            }

            const notulenInput = document.querySelector('input[name="notulen[]"]');
            if (notulenInput) {
                notulenInput.addEventListener('change', function() {
                    createFilePreview(this, document.getElementById('preview-notulen'));
                });
            }

            const materiInput = document.querySelector('input[name="materi[]"]');
            if (materiInput) {
            ...
            if (beritaAcaraInput) {
                beritaAcaraInput.addEventListener('change', function() {
            ...
            // File validation
            const fileInputs = [
                { name: 'foto_kegiatan[]', max: 10, maxSize: 3 * 1024 * 1024 },
                { name: 'daftar_hadir[]', max: 10, maxSize: 3 * 1024 * 1024 },
                { name: 'notulen[]', max: 10, maxSize: 3 * 1024 * 1024 },
                { name: 'materi[]', max: 10, maxSize: 3 * 1024 * 1024 },
                { name: 'berita_acara[]', max: 10, maxSize: 3 * 1024 * 1024 }
            ];
                ...
                if (input) {
                    input.addEventListener('change', function() {
                        ...
                        if (files.length > config.max) {
                            alert(`Maksimal ${config.max} file untuk ${config.name.replace('[]', '')}`);
                            this.value = '';
                            return;
                        }
                        ...
                        for (let file of files) {
                            if (file.size > config.maxSize) {
                                alert(`Ukuran maksimal file adalah 3MB untuk ${config.name.replace('[]', '')}`);
                                this.value = '';
                                return;
                            }
                        }
